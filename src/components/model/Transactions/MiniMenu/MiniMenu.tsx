...
const MiniMenu: React.FC<TransactionProps> = ({linkIsEnable, children,headingColReverse,linkPath, linkContent}) => {
    ...
    return (
        ...
        <div className="flex justify-between items-center flex-wrap gap-5">
            ...
            <div className={`flex ${headingColReverse ? 'lg:flex-col-reverse': 'lg:flex-col'}
             flex-row justify-between w-full lg:w-auto flex-wrap gap-5`}>
